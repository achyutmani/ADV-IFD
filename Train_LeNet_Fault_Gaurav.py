...
class CNN_Model(nn.Module): # Subband-1 Network using Pre-Trained Resent-34
    def __init__(self):
        ...
        self.CNN1=nn.Conv2d(1,6,kernel_size=(3,3))
        self.MP1=nn.MaxPool2d(kernel_size=2)
        self.CNN2=nn.Conv2d(6,16,kernel_size=(3,3))
...
def evaluate(model,device,iterator, criterion): # Evaluate Validation accuracy 
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator) 
MODEL_SAVE_PATH = os.path.join("/home/mani/Desktop/IJCNN 2022/Bear Fault Detection", 'Fault_LeNet.pt') # Define Path to save the model 
