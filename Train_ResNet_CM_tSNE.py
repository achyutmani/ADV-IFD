...
#plt.show()
feature_extractor = torch.nn.Sequential(*list(Fault_Model.children())[:-1])
...
plt.legend(bbox_to_anchor=(1,0.75),prop={'size':20})
plt.xticks(size=30)
plt.yticks(size=30)
...
plt.savefig('R-18_tSNE_CWRU.pdf', bbox_inches='tight') # bbox_inches removes extra white spaces      
